...
const queryParams = [
	// Title with Buttons
	'populate[blocks][populate][0]=buttons',
	// Reviews
	'populate[blocks][populate][1]=title.link',
	'populate[blocks][populate][2]=reviews.author.avatar',
	// Accordions
	'populate[blocks][populate][3]=accordions',
	// Team
	'populate[blocks][populate][4]=team.contacts',
	'populate[blocks][populate][5]=team.info',
	'populate[blocks][populate][6]=team.image',
];
// 10.07.2024
